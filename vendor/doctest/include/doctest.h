    ...
    struct ConsoleReporter : public IReporter
    {
        ...
        void printRegisteredReporters() {
            ...
            auto printReporters = [this] (const reporterMap& reporters, const char* type) {
                if(reporters.size()) {
                    s << Color::Cyan << "[test] " << Color::None << "listing all registered " << type << "\n";
        ...
        void report_query(const QueryData& in) override {
            if(opt.version) {
                ...
                s << Color::Cyan << "[test] " << Color::None << "listing all test suites\n";
                separator_to_stream();
        ...
        void test_run_end(const TestRunStats& p) override {
            ...
            s << Color::Cyan << "[test] " << Color::None << "test cases: " << std::setw(totwidth)
            ...
            s << "\n";
            s << Color::Cyan << "[test] " << Color::None << "assertions: " << std::setw(totwidth)
              << p.numAsserts << " | "
